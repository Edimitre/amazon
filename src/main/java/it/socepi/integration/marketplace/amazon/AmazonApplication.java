...
public class AmazonApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order order = new Order("Order1","via Stelvio","1 cap","milano ","provincia1","123456789","324323",date1,new BigDecimal(2),new BigDecimal(2),new BigDecimal(2), State.PROCESSED,article);
		Order order2 = new Order("Order2","via Stelvio","1 cap","Peruggia","provincia2 ","678909087","324044",date2,new BigDecimal(2),new BigDecimal(2),new BigDecimal(2), State.PENDING,article2);
		Order order3 = new Order("Order3","via Stelvio","1 cap","Bari","provincia 3","123476354","324332",date3,new BigDecimal(2),new BigDecimal(2),new BigDecimal(2), State.ERROR,article3);
